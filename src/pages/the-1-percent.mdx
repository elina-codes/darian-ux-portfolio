...
> <p>Next was the documentation to communicate the designs back to the client so they could share it with their developers. 
  </p>
  <p><a href="https://docs.google.com/document/d/1Go9_JUByYNOyERjL4fB--vRG3UUAUo3wOsRwgXYIs1Y/edit?usp=sharing" target="_blank" rel="noreferrer noopener">Link to the documentation</a>
  </p>
  <p>While the backend was being worked on, I also took this opportunity to teach myself everything else in the process of releasing and Android app to the world, such as researched the submission process, learning how microtransactions work, legalalities, and the
    website splash page.
  </p>
</WorkSection>
