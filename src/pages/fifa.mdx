...
>
  ...
  <h3>My Role</h3>
  <p>
    <strong>I helped out on the design and production team</strong> by writing news stories for career mode, setting up tournaments, and answering questions from the translation team in Spain.
  </p>
</WorkSection>
