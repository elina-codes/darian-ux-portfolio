...
export const currentMethod = uxMethods.card_sorting
...
<MethodSectionWhatIs method={currentMethod} title="What is Card Sorting?">
  <p>
...
<MethodSectionNeeds title="What do you need for Card Sorting?">
...
<MethodSectionSteps method={currentMethod} title="How do you conduct a Card Sorting session?">
  <ol>
    <li>
...
<MethodSectionTips method={currentMethod} title="Tips for a great Card Sort">
  <ul>
    <li>
