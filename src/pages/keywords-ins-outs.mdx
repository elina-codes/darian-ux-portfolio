...
<WorkSection
  title="Prototype, Testing, Release"
  subtitle="The Adapted Strategy"
  image={require("../images/work/keywords-ins-outs-07.jpg")}
  alt="A screenshot of the draft report."
>
  <p>
...
<NextSteps title="Outcome">
  ...
  <br></br>
  <ul>
    <li>68% drop in CS tickets concerning the ins and outs of keywords in a tag.</li>
    <li>94% drop in repeat support tickets concerning this topic.</li>
    <li>This was our 4th most popular report, out of 15 reports.</li>
    <li>CS has “time spent” on these requests to under 30 minutes a week, down from 9.3 hours a week.</li>
  </ul>
  </p>
</NextSteps>
